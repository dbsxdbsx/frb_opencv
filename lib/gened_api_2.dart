...
class Api2Platform extends FlutterRustBridgeBase<Api2Wire> {
  Api2Platform(ffi.DynamicLibrary dylib) : super(Api2Wire(dylib));
...
class Api2Wire implements FlutterRustBridgeWireBase {
  @internal
  ...
  Api2Wire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  void wire_test_string_int_2(
    ...
    return _wire_test_string_int_2(
      port_,
      s,
      i,
    );
  ...
  late final _wire_test_string_int_2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
              ffi.Uint32)>>('wire_test_string_int_2');
  late final _wire_test_string_int_2 = _wire_test_string_int_2Ptr
